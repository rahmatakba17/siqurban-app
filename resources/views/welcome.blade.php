...
<head>
    ...
    <meta name="description" content="SI Qurban membantu panitia masjid mengelola distribusi daging kurban secara tertib, terdokumentasi, dan mudah dioperasikan.">
    ...
    <style>
        ...
        .float-anim-delay { animation: floatY 4s ease-in-out infinite 1.5s; }
        @keyframes floatY {
...
<body class="bg-slate-950 text-white overflow-x-hidden">
        ...
        <div class="mx-auto max-w-7xl flex items-center justify-between px-4 py-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <span class="ml-2 text-[10px] font-semibold uppercase tracking-wider text-primary/80 hidden sm:inline">v2.0</span>
                </div>
            </div>
            <div class="flex items-center gap-3">
                <a href="{{ route('login') }}" class="text-sm font-medium text-stone-300 hover:text-white transition px-4 py-2 rounded-xl hover:bg-white/5">Masuk</a>
                <a href="{{ route('register') }}" class="inline-flex items-center gap-2 rounded-xl bg-primary px-4 py-2 text-sm font-semibold text-white hover:bg-teal-600 transition shadow-lg shadow-primary/30">
                    Daftar Panitia
                </a>
            </div>
        </div>
    ...
    <section class="relative min-h-screen flex items-center pt-20 overflow-hidden">
        ...
        <div class="absolute bottom-10 right-1/4 w-64 h-64 bg-teal-400/20 rounded-full blob pointer-events-none" style="animation-delay:2s"></div>

        <div class="relative mx-auto max-w-7xl px-4 py-24 grid lg:grid-cols-2 gap-16 items-center">
            <div>
                <div class="inline-flex items-center gap-2 rounded-full border border-primary/40 bg-primary/10 px-4 py-1.5 text-sm font-semibold text-primary mb-8">
                    <span class="w-2 h-2 rounded-full bg-primary animate-pulse"></span>
                    Tugas RPL — Magister Teknik Informatika
                </div>
                <h1 class="text-5xl md:text-6xl font-black leading-tight text-white">
                    Distribusi<br>
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary to-teal-400">Kurban Digital</span><br>
                    Lebih Tertib
                </h1>
                <p class="mt-6 text-lg text-stone-400 max-w-lg leading-relaxed">
                    SI Qurban membantu panitia masjid dan lembaga mengelola distribusi daging kurban — dari generate kupon QR Code hingga verifikasi scan saat pembagian.
                </p>
                <div class="mt-8 flex flex-wrap gap-4">
                    <a href="{{ route('register') }}" class="inline-flex items-center gap-2 rounded-2xl bg-primary px-6 py-3.5 text-base font-bold text-white shadow-xl shadow-primary/40 hover:bg-teal-600 transition-all hover:-translate-y-0.5">
                    ...
                    <a href="{{ route('login') }}" class="inline-flex items-center gap-2 rounded-2xl border border-white/10 bg-white/5 px-6 py-3.5 text-base font-semibold text-white hover:bg-white/10 transition-all hover:-translate-y-0.5">
                        Masuk ke Dashboard
            ...
            <div class="relative float-anim">
                <div class="rounded-3xl border border-white/10 bg-white/5 backdrop-blur-sm p-6 shadow-2xl">
                        ...
                        <div class="space-y-2">
                            ...
                            <div>
                                ...
                                <div class="h-1.5 rounded-full bg-white/10">
                                    <div class="h-full rounded-full bg-primary" style="width:{{ [75,60,90][$i] }}%"></div>
                                </div>
                            </div>
                            @endforeach
                        </div>
                    ...
                    <div class="mt-4 flex items-center gap-3 rounded-2xl border border-white/10 bg-white/5 p-3">
                        ...
                        <span class="ml-auto text-[10px] font-bold text-emerald-400 rounded-full bg-emerald-400/10 px-2 py-1">Diterima</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="bg-slate-900 py-24">
        <div class="mx-auto max-w-7xl px-4">
            <div class="text-center mb-16">
                ...
                <p class="mt-4 text-stone-400 max-w-2xl mx-auto">Dari generate kupon otomatis hingga scan QR Code saat pembagian — semuanya terintegrasi dalam satu sistem.</p>
            </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="feature-card rounded-2xl border border-white/10 bg-white/5 p-6">
                    <div class="w-12 h-12 rounded-2xl bg-gradient-to-br {{ $f['color'] }} flex items-center justify-center mb-4 border border-white/10">
        ...
        <div class="mx-auto max-w-7xl px-4">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <div class="rounded-3xl border border-primary/30 bg-primary/5 p-8">
                    ...
                    <p class="text-stone-400 mb-6 text-sm">Kontrol penuh atas seluruh sistem distribusi kupon kurban.</p>
                    <ul class="space-y-2.5">
                        ...
                        <li class="flex items-start gap-2.5 text-sm text-stone-300">
                            <svg class="w-4 h-4 text-primary shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
                            {{ $item }}
                        </li>
                        @endforeach
                    </ul>
                ...
                <div class="rounded-3xl border border-sky-500/30 bg-sky-500/5 p-8">
                    ...
                    <ul class="space-y-2.5">
                        ...
                        <li class="flex items-start gap-2.5 text-sm text-stone-300">
                            <svg class="w-4 h-4 text-sky-400 shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
                            {{ $item }}
                        </li>
                        @endforeach
                    </ul>
    ...
    <section class="hero-gradient py-24">
        <div class="mx-auto max-w-3xl px-4 text-center">
            ...
            <p class="text-teal-100/80 text-lg mb-10">Daftarkan akun panitia dan mulai kelola kupon kurban secara digital hari ini. Gratis, cepat, dan mudah digunakan.</p>
            <div class="flex flex-wrap gap-4 justify-center">
                <a href="{{ route('register') }}" class="inline-flex items-center gap-2 rounded-2xl bg-white px-8 py-4 text-base font-bold text-primary shadow-xl hover:bg-stone-100 transition-all hover:-translate-y-0.5">
                ...
                <a href="{{ route('login') }}" class="inline-flex items-center gap-2 rounded-2xl border border-white/30 px-8 py-4 text-base font-semibold text-white hover:bg-white/10 transition-all">
        ...
        <div class="mx-auto max-w-7xl px-4 flex flex-col md:flex-row items-center justify-between gap-4">
            <div class="flex items-center gap-3">
                <div class="w-8 h-8 rounded-xl bg-primary/20 flex items-center justify-center">
                    <svg class="w-4 h-4 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>
                </div>
                <span class="font-bold text-white">SI Qurban</span>
                <span class="text-stone-500 text-sm">— Magister Teknik Informatika, RPL</span>
            </div>
            <p class="text-stone-500 text-sm">Laravel 11 · TailwindCSS · MySQL · Docker</p>
        </div>
    </footer>
